# Generated by Django 2.0.4 on 2018-04-18 13:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.OneToOneField(on_delete='on_delete', to='blog.Author')),
            ],
        ),
        migrations.CreateModel(
            name='Book',
        ...
        migrations.AddField(
            model_name='book',
            name='publisher',
            field=models.ForeignKey(on_delete='on_delete', to='blog.Publisher'),
        ),
    ]
